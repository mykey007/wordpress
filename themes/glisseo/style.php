...
.anyAge{float:left; width:296px; height:290px; margin:10px; position:relative; font-size:13px !important; line-height:22px !important; text-transform:none !important;}
.anyAgeRec{background: url(http://localhost/wordpress/wp-content/uploads/2012/12/recommendProce.png) 0 0 no-repeat; width:125px; height:123px; position:absolute; right:0; bottom:0;}
.anyAgeRec:hover{background: url(http://localhost/wordpress/wp-content/uploads/2012/12/recommendProceHover.png) 0 0 no-repeat;}
.clear{clear:both;}
